// ============================================================
// OpenZakat – Gold Unit Tests
// PRD §10 – Tests #31, #32 (expat-specific)
// ============================================================
...
describe('Gold Unit Conversions', () => {
  // PRD Test #31: Sovereign to gram conversion
  ...
  // PRD Test #32: Tola to gram conversion
  ...
  it('India 22K purity = 91.6%', () => {
    ...
    const purity = pureGrams / grossGrams;
    expect(purity).toBeCloseTo(0.916, 2);
  });
